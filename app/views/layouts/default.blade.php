...
<html>
  <head>
    ...
    <meta name="description" content="rezervacni system Zeny sobe">
    <meta name="keywords" content="zeny,sobe">
    <meta name="author" content="Mt">
    {{ HTML::style('css/styly.css') }}
  </head>
  <body>

  <a href="http://localhost/wa1/public/about">{{HTML::image('img/header.jpg', '', array('class' => 'logoImg', 'alt' => 'Logo'))}}</a>
  ...
  <div class=spodek>
    <br>
    <br>
    {{ HTML::image('img/left.png','', array('class' => 'levyIMG', 'alt' => 'leftImage')) }} 
    {{ HTML::image('img/right.png','', array('class' => 'pravyIMG', 'alt' => 'rightImage')) }}
    @yield('content')
  </div>
  <div class=zapati>
